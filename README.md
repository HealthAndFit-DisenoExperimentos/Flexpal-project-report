...
![upc-logo-transparente](https://github.com/user-attachments/assets/f981aa50-acc1-4a45-ae01-e60380e31abf)

<h5 style="text-align: center"> Ingeniería de Software </h5>
<h5 style="text-align: center"> Diseño de Experimentos- SW72 </h5>

<h5 style="text-align: center"> Docente: Juan Carlos Tinoco Licas </h5>

<h5 style="text-align: center"> Startup: Health&Fit </h5>

<h5 style="text-align: center"> Producto: Flexpal </h5>
<h5 style="text-align: center"> Septiembre - 2024 </h5>
...
|---------|------------|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1       | 24/08/2024 | - Miguel Carpio   | - Añadió contenido a todos los capítulos <br> - Aportó ideas para la creación de User Stories <br> - Realizó código para el despliegue de la Landing Page <br> - Adicionó las secciones que pertenecen al capítulo 1 hasta el 2.                                                                                        |
| 1       | 24/08/2024 | - Miguel Carpio | - Realizó diseño de entrevistas <br> - Realizó análisis de entrevistas <br> - Realizó User Persona <br> - Realizó empathy mapping <br> - Realizó as is scenario mapping  <br>    - Realizó source code management <br> - Realizó source code style guide & conventions <br> - Realizó software deployment configuration |
| 1       | 24/08/2024 | - Jessica Comettant       | - Implementó segmentos objetivos para el proyecto <br> - Implementó Landing Page UI Design, Mockups. <br> - Implementó Web Applications UX/UI Design, Web Applications Prototyping, Domain-Driven Software Architecture. <br> - Implementó las bases para el desarrollo de la lading page                               |
| 1       | 27/08/2024 | - Jessica Comettant   | - Realizó diagramas de clase <br> - Realizó diagramas de base de datos <br> - Realizó entrevista para un segmento <br> - Aplicó el uso de conventional commits. <br> - Aportó con conocimiento sobre el nicho de membresías en el ámbito del gimnasio.                                                                  |
| 1       | 27/08/2024 | - Jessica Comettant    | - Culminó con el capítulo 3 agregando el impact map y product backlog <br> - Realizó entrevistas para un segmento objetivo <br> -Lideró impact map, user stories, product backlog.                                                                                                                                      |
| 2       | 27/08/2024 | - Jessica Comettant    | - Corrigió, mediante commits dirigidos al "refactor", el nombre de los archivos en assets <br> - Agregó el seguimiento que faltaba en la sección "Project Report Collaboration Insights" <br> - Investigó y se realizó de forma correcta los "Lean UX Assumptions" <br> - . . .                                         |
| 2       | 30/08/2024 | -  | - Corrigió user task matrix <br> - Corrigío style guidelines <br> - Agregó descripciones faltantes en todos los capítulos <br> - Realizó componentes haciendo uso de primevue en conjunto con html, css y javascript                                                                                                    |
...
|----------|----------|----------|
| La capacidad de reconocer responsabilidades éticas y profesionales en situaciones de ingeniería y hacer juicios informados, que deben considerar el impacto de las soluciones de ingeniería en contextos globales, económicos, ambientales y sociales. |  **-----------TB1-----------**<br>  **Miguel Carpio** <br> Documentó las medidas de seguridad implementadas para proteger los datos personales de los usuarios, asegurando la privacidad de su información de salud y progreso físico. Registró la adaptación de los planes de nutrición y rutinas de ejercicio a diferentes contextos culturales, destacando la inclusión y accesibilidad. <br> |  **-----------TB1-----------**<br>  Como equipo, llegamos a la conclusión de que la documentación detallada de nuestras acciones y decisiones nos permite asegurarnos de que FlexPal cumpla con los estándares de privacidad, seguridad y accesibilidad. La documentación describió cómo abordamos la inclusión cultural y la sostenibilidad para tener un impacto positivo y ético en la vida de los usuarios. Esta documentación detallada no solo ayudó con el progreso del proyecto, sino que también reafirmó nuestra dedicación a cumplir con nuestras obligaciones profesionales y éticas durante el diseño y la implementación de la plataforma. <br> |
